(function() {
    ...
    async function fetchPollState() {
        ...
        const response = await fetch(`${apiBaseUrl}/poll/questions?user_id=${encodeURIComponent(pollUserId)}`);
        if (!response.ok) {
    ...
    async function submitQuestion(event) {
        ...
        try {
            ...
            const response = await fetch(`${apiBaseUrl}/poll/questions`, {
                method: "POST",
                headers: {
    ...
    async function toggleVote(questionId) {
        ...
        try {
            ...
            const response = await fetch(`${apiBaseUrl}/poll/questions/${encodeURIComponent(questionId)}/vote`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
